...
public class AseFileImporter : ScriptedImporter
{
    ...
    private void ImportSprites(AssetImportContext ctx, AseFile aseFile)
    {
        ...
        {
            Sprite sprite = Sprite.Create(atlas, new Rect(i * aseFile.Header.Width, 0, aseFile.Header.
                Width, aseFile.Header.Height), textureSettings.spritePivot, textureSettings.pixelsPerUnit, textureSettings.extrudeEdges, textureSettings.meshType, Vector4.zero, textureSettings.generatePhysics);
    ...
    private void ImportTileset(AssetImportContext ctx, Texture2D atlas)
    {
        ...
        for (int y = rows - 1; y >= 0; y--)
        {
            for (int x = 0; x < cols; x++)
            {
                ...
                Sprite sprite = Sprite.Create(atlas, tileRect, textureSettings.spritePivot, textureSettings.pixelsPerUnit, textureSettings.extrudeEdges, textureSettings.meshType, Vector4.zero, textureSettings.generatePhysics);
